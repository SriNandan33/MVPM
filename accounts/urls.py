...
urlpatterns=[
    ...
    url(r'dashboard/notifications/mark_all_read/$', views.mark_all_as_read, name='mark_all_read'),
    url(r'dashboard/notifications/(?P<id>\d+)/mark_as_read/$', views.mark_one_as_read, name='mark_all_read'),
